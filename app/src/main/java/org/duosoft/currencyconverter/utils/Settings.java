...
public class Settings {
    ...
    public static int getDefaultCurrencyIdFrom () {
        return PreferenceManager.getDefaultSharedPreferences(App.getAppContext()).getInt("default_currency_from", 9);
    }
    ...
    public static int getDefaultCurrencyIdTo () {
        return PreferenceManager.getDefaultSharedPreferences(App.getAppContext()).getInt("default_currency_to", 142);
    }
    ...
    public static String getDefaultLanguage() {
        return PreferenceManager.getDefaultSharedPreferences(App.getAppContext()).getString("default_language", Settings.LANGUAGE_EN); //Russian currency names
    }
